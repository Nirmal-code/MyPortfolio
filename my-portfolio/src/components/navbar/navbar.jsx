...
export default class navbar extends Component{
    ...
    render(){
        return(
            <div className="text-[3rem] sm:text-[3rem] md:text-[3rem] lg:text-[3.5rem] xl:text-[4.5rem] fixed bottom-7 left-[10vw] p-3 rounded-full w-[80vw] bg-slate-300 bg-white bg-opacity-50 shadow-1xl shadow-[#71717a]">
                <div className="flex justify-center">
                    ...
                    <a><MdWorkHistory className="p-3 text-white bg-black rounded-lg hover:scale-125 border-2 border-black hover:cursor-pointer mr-2.5" /></a>
